            ...
            <main>
                ...
                <section className="relative pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 lg:pb-20 overflow-hidden">
                    ...
                    <div className="mx-auto w-[94%] xl:w-[90%] 2xl:w-[85%]">
                        ...
                        {/* Tag Badge */}
                        {portfolio.tag && (
                            <span className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00BFD2]/10 to-[#0891b2]/10 text-[#00BFD2] px-4 py-1.5 rounded-full text-sm font-semibold mb-4">

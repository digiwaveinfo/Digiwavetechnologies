            ...
            <div className="flex flex-col gap-[30px] lg:w-[20%]">
              ...
              <div className="flex flex-col gap-[13px] whitespace-nowrap">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#00114C] text-base font-normal font-['Inter'] leading-[26px]">info@digiwavetechnologies.in</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                  ...
                  <span className="text-[#00114C] text-base font-normal font-['Inter'] leading-[26px]">+91 9428418099</span>
                </div>
              </div>

    ...
    <section className="w-full py-16 md:py-24 flex flex-col justify-start items-center bg-white relative overflow-hidden">
      ...
      <div className="absolute left-0 top-0 w-[1164px] h-[919px] opacity-10 pointer-events-none z-0">
        <svg
          ...
          className="absolute left-[251.78px] top-0"
        >
          <path
            d="M744.674 920.25C744.674 920.25 807.771 728.427 778.592 610.148C695.44 273.093 20.5165 965.871 -109.721 644.066C-217.442 377.898 247.219 1.25026 247.219 1.25026"
            stroke="#00BFD2"
            strokeWidth="3.23023"
          />
        </svg>
        ...
        >
          <path
            d="M492.891 920.25C492.891 920.25 555.988 728.427 526.809 610.148C443.657 273.093 -231.266 965.871 -361.504 644.066C-469.225 377.898 -4.56385 1.25026 -4.56385 1.25026"
            stroke="#00BFD2"
            strokeWidth="3.23023"
          />
        </svg>
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-[88.12px] top-0"
        >
          <path
            d="M581.014 920.25C581.014 920.25 644.111 728.427 614.931 610.148C531.78 273.093 -143.144 965.871 -273.382 644.066C-381.103 377.898 83.5587 1.25026 83.5587 1.25026"
            stroke="#00BFD2"
            strokeWidth="3.23023"
          />
        </svg>
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-[185.69px] top-0"
        >
          <path
            d="M678.581 920.25C678.581 920.25 741.677 728.427 712.498 610.148C629.346 273.093 -45.577 965.871 -175.815 644.066C-283.536 377.898 181.125 1.25026 181.125 1.25026"
            stroke="#00BFD2"
            strokeWidth="3.23023"
          />
        </svg>
      ...
      <div className="absolute right-[-500px] top-0 w-[1106px] h-[873px] opacity-10 pointer-events-none z-0">
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-[239.27px] top-0"
        >
          <path
            d="M828.881 0.477173C828.881 0.477173 888.843 182.771 861.114 295.173C782.093 615.483 140.701 -42.8769 16.933 262.941C-85.4363 515.885 356.14 873.821 356.14 873.821"
            stroke="#00BFD2"
            strokeWidth="3.06975"
          />
        </svg>
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-[83.74px] top-0"
        >
          <path
            d="M828.881 0.477173C828.881 0.477173 888.843 182.771 861.114 295.173C782.093 615.483 140.701 -42.8769 16.933 262.941C-85.4363 515.885 356.14 873.821 356.14 873.821"
            stroke="#00BFD2"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-[176.46px] top-0"
        >
          <path
            d="M828.881 0.477173C828.881 0.477173 888.843 182.771 861.114 295.173C782.093 615.483 140.701 -42.8769 16.933 262.941C-85.4363 515.885 356.14 873.821 356.14 873.821"
            stroke="#00BFD2"
